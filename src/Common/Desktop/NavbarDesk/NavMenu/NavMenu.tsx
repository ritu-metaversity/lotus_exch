...
const menu = [
  ...
  { title: "Cricket", link: "/d/sport/4", auth: false },
  { title: "Virtual Sports", link: "#/virtual-sports", auth: false },
  { title: "Football", link: "/d/sport/1", auth: false },
  { title: "Tennis", link: "/d/sport/2", auth: false },
  { title: "Basketball", link: "#/display/EVENT_TYPE/7522", auth: false },
  { title: "Golf", link: "#/display/EVENT_TYPE/3", auth: false },
  { title: "Horse Racing", link: "/d/horseracing/7", auth: false },
