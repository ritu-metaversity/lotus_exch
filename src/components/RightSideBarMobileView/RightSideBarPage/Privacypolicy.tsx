    ...
    >
      ...
      <div className="general">
        <p>
          ...
          of LOTUS 365 Website, located at www.LOTUS 365.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions.
          Do not continue to use LOTUS 365.com if you do not agree to take all of
        ...
        <p>
          ...
          and “Us”, refers to LOTUS 365. “Party”, “Parties”, or “Us”, refers to both
        ...
        <ul>
          <li>
            We employ the use of cookies. By accessing LOTUS 365.com, you agreed to
            use cookies in agreement with the LOTUS 365 Privacy Policy.
          </li>
          <li>
        ...
        <ul>
          <li>
            Unless otherwise stated, LOTUS 365 and/or its licensors own the
            intellectual property rights for all material on LOTUS 365.com. All
            intellectual property rights are reserved. You may access this from
            LOTUS 365.com for your own personal use subjected to restrictions set in
            these terms and conditions.
          </li>
        </ul>
        <p>You must not:</p>
        <ul>
          <li>Republish material from LOTUS 365.com</li>
          <li>Sell, rent or sub-license material from LOTUS 365.com</li>
          <li>Reproduce, duplicate or copy material from LOTUS 365.com</li>
          <li>Redistribute content from LOTUS 365.com</li>
        </ul>
        <p>
          Parts of this website offer an opportunity for users to post and exchange
          opinions and information in certain areas of the website. LOTUS 365 does
          not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of LOTUS 365,
          ...
          applicable laws, LOTUS 365 shall not be liable for the Comments or for any
        ...
        <p>
          LOTUS 365 reserves the right to monitor all Comments and to remove any
        ...
        <ul>
          ...
          <li>
            You hereby grant LOTUS 365 a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          hyperlink compensates the absence of LOTUS 365; and (d) the link is in the
        ...
        <p>
          ...
          e-mail to LOTUS 365. Please include your name, your organization name,
        ...
        <ul>
          ...
          <li>
            No use of LOTUS 365’s logo or other artwork will be allowed for linking
