import "./ExclusionPolicy.css"

const ExclusionPolicy = () => {
  return (
    <div className="ExclusionPolicy" style={{ marginLeft: 15, marginRight: 15 }}>
      ...
      <div className="general">
        ...
        <p>
          ...
          request by email to{" "}
          <a href="support@lotus365.com" style={{ color: "rgb(37, 123, 36)" }}>
            support@lotus365.com
          </a>
        </p>
        <p>
