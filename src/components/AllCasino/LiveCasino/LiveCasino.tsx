	...
	return (
		<div className='AllCasinoGame_IN_onePage'>
			<div className='liveCasino-headerrrrrr'>
				<img
					src='https://lotus365.co/static/media/LiveCasinoMobileTop.6252968a.png'
					className='liveCasino-header__img mob_img'
				/>
				<img
					src='https://lotus365.co/static/media/livecasinoLobby.16d18b4a.svg'
					className='liveCasino-header__img desk_img'
				/>
			...
			<div className='gamebtnnnnsnnsns'>
				{data?.['Super Nova']?.active === true ? (
					<button
						onClick={() => handleGameName('SuperNowa')}
						className='GameNameBtn_UIiiii'
					>
						Super nowa
					</button>
				) : (
				...
				{data?.Aura?.active === true ? (
					<button onClick={handleGameName} className='GameNameBtn_UIiiii'>
						Aura
					</button>
				) : (
					''
			...
			<div className='gamedetttttttt'>
				{casinoListSuperNowa &&
					casinoListSuperNowa.map((item: any) => (
						<div
							className='liveCasino-content__menu-games__allgames-items-item'
			...
			>
				<Box sx={style}>
					<CasinoPointPopup
						...
						type={casinoListPointType}
					/>
					<button
						onClick={handleAgree}
						className='slotsCasino-pop-up__content-button'
					>
						OK, I AGREE !
					</button>
				</Box>
